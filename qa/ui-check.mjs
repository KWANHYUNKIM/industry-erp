 ...
 */
{
  ...
  const NO_FIELD_ON = new Map([
     ...
     * [기타] 안에 <b>수정일자순(정렬)</b>과 <b>외주공장만</b> 둘이 있다 — 뒤엣것은
     * 창고에 [외주] 갈래가 있어야 걸 수 있는데, 우리 Warehouse.kind 가 그 갈래를 들지만
     * <b>생산입고 응답이 창고 갈래를 안 싣는다</b>. 창고명만으로는 외주인지 못 가른다.
     */
    /*
     ...
     *
     * <p><b>[기타]는 이름만 같고 뜻이 다르다</b> — 원본의 체크는 [수량관리제외품목포함]
     * 하나(꺼짐)고 우리 것은 [차이있는것만] 이다. 실사 요청 줄이 품목의 수량관리 여부를
     * 들고 있지 않아 그 체크를 만들 수 없다.
     *
