 ...
 */
{
  ...
  const NO_COLUMN = new Map([
    ...
    /*
     * <b>[생산공정명]</b> - 2026-09-09 원본 격자 실측.
     * 원본은 재공을 <b>공정별로</b> 들고 있어 원가집계표의 넷째 칸이 생산공정명이다.
     * 우리 재고는 <b>창고 단위</b>라 공정별 재공이 없다 - 그 칸에 넣을 값이 아예 없다.
     * 창고를 공정처럼 쓰면 이름만 같고 다른 값이 된다.
     *
     * <p><b>실제원가현황은 예외에서 뺐다</b>(2026-09-09) - 같은 날 만든
     * [노무비배부액]·[경비배부액] 의 <b>배부 전 표</b>가 공정·창고별 총액을 그리면서
     * 그 화면에 [생산공정명] 열이 생겼다. 배부는 원래 공정 단위라 그 칸이 제자리다.
     * <b>원가집계표 쪽 재공은 여전히 공정별로 못 가른다</b> - 아래 두 화면이 그대로 남는 까닭이다.
     */
    ['차이분석|생산공정명', '우리 재고는 창고 단위라 공정별 재공이 없다 - 그 칸에 넣을 값이 없다'],
