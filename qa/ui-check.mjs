 ...
 */
{
  ...
  const NO_TAB = new Map([
    ...
    ['품목등록|품목정보', '<b>아직 안 만들었다.</b> 원본은 품목등록 폼을 여섯 탭으로 나누는데 우리는 한 화면에 죽 편다'],
    ['품목등록|수량', '<b>아직 안 만들었다.</b> 원본은 품목등록 폼을 여섯 탭으로 나누는데 우리는 한 화면에 죽 편다'],
    ['품목등록|단가', '<b>아직 안 만들었다.</b> 원본은 품목등록 폼을 여섯 탭으로 나누는데 우리는 한 화면에 죽 편다'],
    ['품목등록|원가', '<b>아직 안 만들었다.</b> 원본은 품목등록 폼을 여섯 탭으로 나누는데 우리는 한 화면에 죽 편다'],
    ['품목등록|부가정보', '<b>아직 안 만들었다.</b> 원본은 품목등록 폼을 여섯 탭으로 나누는데 우리는 한 화면에 죽 편다'],
    ['품목등록|관리대상', '<b>아직 안 만들었다.</b> 원본은 품목등록 폼을 여섯 탭으로 나누는데 우리는 한 화면에 죽 편다'],
    /*
