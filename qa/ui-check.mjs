 ...
 */
{
  ...
  const NO_FIELD_ON = new Map([
     ...
     */
    /*
     * 원본은 [담당자](전표를 친 사람)와 [거래처관리담당자](거래처에 붙은 사람)를 따로 둔다.
     * 우리 목록 응답(SlipResponse)에는 전표 담당자만 실린다 — 거래처의 관리담당자를
     * 실으려면 응답에 그 필드부터 더해야 한다.
     */
    ['구매일괄회계반영|거래처관리담당자', '목록 응답에 거래처의 관리담당자가 없다'],
    ['회계미반영현황 (구매)|거래처관리담당자', '위와 같음'],
    ['회계미반영현황(판매)|거래처관리담당자', '위와 같음'],
    ['판매일괄회계반영|거래처관리담당자', '위와 같음'],
