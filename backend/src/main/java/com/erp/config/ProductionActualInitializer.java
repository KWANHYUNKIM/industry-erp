...
public class ProductionActualInitializer implements CommandLineRunner {
    ...
    private void seedWorkOrdersAndProductions(Map<String, Item> items, Warehouse wh) {
        ...
        productionService.create(new CreateProductionRequest(wo1.getId(), BigDecimal.valueOf(100), LocalDate.of(2026, 7, 5), null, null, null, null, null), null);
        productionService.create(new CreateProductionRequest(wo2.getId(), BigDecimal.valueOf(120), LocalDate.of(2026, 7, 6), null, null, null, null, null), null);
        productionService.create(new CreateProductionRequest(wo3.getId(), BigDecimal.valueOf(50), LocalDate.of(2026, 7, 7), null, null, null, null, null), null);
    }
