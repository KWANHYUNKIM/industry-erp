...
public class ProductionActualInitializer implements CommandLineRunner {
    ...
    private void seedWorkOrdersAndProductions(Map<String, Item> items, Warehouse wh) {
        ...
        productionService.create(CreateProductionRequest.of(wo1.getId(), BigDecimal.valueOf(100), LocalDate.of(2026, 7, 5)), null);
        productionService.create(CreateProductionRequest.of(wo2.getId(), BigDecimal.valueOf(120), LocalDate.of(2026, 7, 6)), null);
        productionService.create(CreateProductionRequest.of(wo3.getId(), BigDecimal.valueOf(50), LocalDate.of(2026, 7, 7)), null);
    }
