...
export default function MonthlyCumulativePage() {
   ...
   *
   * <p><b>2026-09-09 원본을 열어 그 판단을 확인했다 — 원본도 똑같이 비운다.</b>
   * 생산입고현황 [년 누계]가 <b>수량 524 인데 공급가액·부가세·합계가 전부 빈칸</b>이었고,
   * 창고이동현황은 세 줄이 통째로 빈칸이었다. 판매·구매만 금액이 찬다
   * (판매 년 누계 201,090,909 / 구매 년 누계 119,438,862).
   * 값이 0 인 칸도 원본은 <b>빈칸</b>으로 둔다 — 우리도 그렇게 그린다.
   *
