 ...
 * 영업관리 > 출하 > 출하조회를 열어 주소창을 읽고 화면을 눈으로 확인하니
 * <code>prgId=E040226</code> 이다(제목도 [출하조회]).
 * <b>메뉴를 누르면 주소창의 해시가 먼저 바뀌고 화면은 나중에 그려진다</b> —
 * 그 사이에 주소를 읽으면 <b>옮겨 가기 전 화면의 코드</b>를 읽게 된다.
 * C000138 이 무슨 화면인지는 모른다. 지어내지 않는다.
