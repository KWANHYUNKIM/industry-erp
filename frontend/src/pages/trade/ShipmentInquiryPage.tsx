...
/**
 * 영업 > 출하조회 (C000138) — 전표(출하) 단위 조회. 행 클릭 시 품목 상세 펼침.
 *
 * <p>이 줄은 사본을 따라 오래도록 <b>E040226</b> 이라 적고 있었는데 <b>틀렸다</b>.
 * 2026-09-08 에 원본을 열어 주소창을 보니 <code>prgId=C000138</code> 이다.
 * 우리끼리 어긋나 있던 것을(머리말 E040226 vs 실측 주석 C000138) 원본이 갈랐다.
