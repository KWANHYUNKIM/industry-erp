 ...
 *
 * <p>그래서 남은 물음은 하나로 좁혀졌다 — <b>수금이 청구분에서 먼저 빠지는가.</b>
 * 그렇다면 <code>미청구 = 세금계산서가 안 붙은 전표 합</code>, <code>청구 = 잔액 − 미청구</code>
 * 로 낼 수 있다. 그 규칙을 원본에서 확인하기 전에는 지어내지 않는다 —
 * 반반으로 갈린 넷이 우연인지 규칙인지 아직 모른다.
 */
