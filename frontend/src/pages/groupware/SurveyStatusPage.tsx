  ...
  return (
    ...
    >
      ...
      {/*
        ...
        <p>[설문대상자]는 <b>답한 사람</b>으로 보고 그렇게 그린다(원본 칸 이름은 대상자다).
        익명 설문이면 서버에 이름이 <b>저장되어 있지 않아</b> (익명)으로 적는다 —
        가리는 것이 아니라 없다.

        <p><b>2026-09-09 원본(E070258)을 열어 가려 보려 했으나 못 잰다</b> —
        그 회사에 설문 자료가 <b>한 건도 없어</b> "등록된 데이터가 없습니다" 만 뜬다.
        머리 일곱 칸은 그대로 확인했다(작성일 · 게시글번호 · 설문종료일 · 설문대상자 ·
        제목 · 질문내용 · 응답내용). 답한 사람인지 보낸 대상 전체인지는 <b>자료가 생겨야</b>
        가려진다 — 지어내지 않고 이대로 둔다.
      */}
      {openId != null && (
        <>
