...
const MENU: TopMenu[] = [
  ...
  },
  {
    ...
    tabs: [
      ...
      { label: '기타이동', nodes: [{ label: '기타이동', to: '/inventory/transfer' }, { label: '재고실사', to: '/inventory/stocktake' }] },
  ...
  },
  {
    label: '재고 II',
    tabs: [
      { label: 'A/S관리', nodes: [{ label: 'A/S관리', to: '/quality/as' }, { label: 'A/S현황', to: '/quality/as-status' }] },
      { label: '시리얼/로트No.', nodes: [{ label: '시리얼/로트No.', to: '/quality/serial-lot' }, { label: '품목vs시리얼재고비교', to: '/quality/lot-compare' }] },
      { label: '품질관리', nodes: [{ label: '품질관리', to: '/quality/inspection' }, { label: '품질검사현황', to: '/quality/inspection-status' }] },
      {
        label: '계획관리',
        nodes: [
