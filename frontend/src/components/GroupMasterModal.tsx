 ...
 * 그룹으로 <b>거르는 자리</b>가 함께 있어야 쓸모가 생기는데, 지금 우리는 그룹을
 * 품목·거래처에 붙이고 채권/채무현황에서 소계로 묶을 뿐 <b>목록을 그룹으로 거르는 조건이
 * 아직 한 곳도 없다.</b> 부모 컬럼만 먼저 넣으면 아무 화면도 존중하지 않는 트리가 생긴다.
 * 걸러 낼 자리를 먼저 만들고, 그다음 계층과 [하위그룹포함검색]을 함께 얹는 것이 맞다.
 */
